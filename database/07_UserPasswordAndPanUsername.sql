-- Migration: store original password, set username from PAN number
USE DMS_DB;
GO
...
-- Backfill username from PAN for users missing username
UPDATE dbo.Users
SET Username = PANNumber
WHERE Username IS NULL AND PANNumber IS NOT NULL;
GO
