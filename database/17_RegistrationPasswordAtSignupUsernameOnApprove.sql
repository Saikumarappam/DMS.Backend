-- Migration: save password at registration; set PAN as username on approval only
USE DMS_DB;
GO
...
-- =============================================================================
-- sp_User_Register (password saved at signup; username assigned on approval)
-- =============================================================================
...
BEGIN
    ...
    BEGIN SET @ResultCode = -5; SET @ResultMessage = 'Password is required.'; RETURN; END
    ...
    INSERT INTO dbo.Users (Name, MobileNumber, Email, PANNumber, Address, BusinessName,
        ContactPersonName, GSTNumber, PasswordHash, OriginalPassword, RoleId, UserStatus, ProfileCompleted)
    VALUES (@Name, @MobileNumber, @Email, @PANNumber, @Address, @BusinessName,
        @ContactPersonName, @GSTNumber, @PasswordHash, @OriginalPassword, @RoleId, 'PendingApproval', 0);
...
-- =============================================================================
-- sp_User_ApproveReject (assign username=PAN; keep registration password)
-- =============================================================================
...
PRINT 'Applied registration password + approval username migration.';
GO
